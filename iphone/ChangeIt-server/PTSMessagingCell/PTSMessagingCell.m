...
- (void)layoutSubviews {
    ...
    if (self.sent == YES) {
        ...
        messageLabelFrame = CGRectMake(self.frame.size.width - (textSize.width + textMarginHorizontal),  ballonViewFrame.origin.y + textMarginVertical/2, textSize.width, textSize.height);
        ...
        messageLabelFrame = CGRectMake(textMarginHorizontal, ballonViewFrame.origin.y + textMarginVertical/2, textSize.width, textSize.height);
